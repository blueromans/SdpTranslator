...
export default function Interop() {
    ...
    /**
     * This map holds RTCSessionDescription and RTCIceCandidate
     *
     * @type {{}}
     */
    this.config = {
...
Interop.prototype.configureOptionalDeps = function(RTCSessionDescription, RTCIceCandidate) {
    this.config.RTCSessionDescription = RTCSessionDescription
    this.config.RTCIceCandidate = RTCIceCandidate
};
...
Interop.prototype.candidateToUnifiedPlan = function(candidate) {
    var cand = new this.config.RTCIceCandidate(candidate);
...
Interop.prototype.toPlanB = function(desc) {
    ...
    return new this.config.RTCSessionDescription({
        type: desc.type,
        sdp: resStr
    });
